...
struct FSSettingsAboutView: View {
    ...
    var v_SourceCode: some View {
        VStack {
            ...
            Text("@ABOUT_SOURCE_INFO", tableName: "Settings")
            ...
            Button(action: {
                ...
                Text("@ABOUT_SOURCE_WEB", tableName: "Settings")
            }
            .padding(.top)
        }
    }
    ...
    var v_Developer: some View {
        VStack {
            ...
            Text("@ABOUT_COPYRIGHT_DEVELOPER", tableName: "Settings")
            Text("@ABOUT_COPYRIGHT_SIGNATURE", tableName: "Settings")
        }
    }
    ...
    var v_AdditionalComponents: some View {
        VStack {
            ...
            Text("@ABOUT_COPYRIGHT_EXTRA", tableName: "Settings")
                .padding(.bottom)
            // Add new copyrights for 3rd party here if needed, no padding
            Text("@ABOUT_COPYRIGHT_EXRTA_ZIP", tableName: "Settings")
                .padding(.bottom)
        }
    }
    ...
    var body: some View {
                ...
                VStack(alignment: .center) {
                    ...
                    VStack {
                        Image("LaunchScreenLogo")
                            ...
                            .padding()
                        Text("@ABOUT_APP_TITLE", tableName: "Settings")
                            .font(.title)
                        Text("@ABOUT_APP_DESC", tableName: "Settings")
                            .font(.subheadline)
                    }
        ...
        .navigationBarTitle(Text("@ABOUT_TITLE", tableName: "Settings"))
