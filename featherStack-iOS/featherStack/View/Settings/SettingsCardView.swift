...
struct FSSettingsCardView: View {
    ...
    var body: some View {
        ZStack {
            List {
                Section(header: Text("@CARD_SWIPE_SECTION", tableName: "Settings")
                            .padding(.top),
                        footer: Text("@CARD_SWIPE_INFO", tableName: "Settings")) {
                    // Right
                    Button(action: {
                        self.c_Settings.b_CDSwipeRightCorrect = true
                    }) {
                        HStack {
                            Text("@CARD_SWIPE_RIGHT", tableName: "Settings")
                    ...
                    Button(action: {
                        ...
                        HStack {
                            Text("@CARD_SWIPE_LEFT", tableName: "Settings")
                                .foregroundColor(Color(.label))
        ...
        .navigationBarTitle(Text("@CARD_TITLE", tableName: "Settings"))
