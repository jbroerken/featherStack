            ...
            TabView(selection: $i_Tab) {
                ...
                FSSetListView(self.$s_AddURL)
                    .tabItem {
                        ...
                        Text("@TAB_CARDSETS", tableName: "SHome")
                    }
                    .tag(0)
                ...
                FSSettingsView()
                    .tabItem {
                        ...
                        Text("@TAB_SETTINGS", tableName: "SHome")
                    }
                    .tag(1)
            }
...
private extension FSHomeView {
    ...
    var navigationBarTitle: String {
        switch (i_Tab) {
            case 1: return NSLocalizedString("@TITLE_SETTINGS",
                                             tableName: "SHome",
                                             comment: "Settings title")
                
            // Use card set as default
            default: return NSLocalizedString("@TITLE_CARDSETS",
                                              tableName: "SHome",
                                              comment: "Card set title")
        }
    }
