...
final class FSSetListViewModel: ObservableObject {
    ...
    struct FSSelection {
        ...
        fileprivate(set) var e_Mode: FSActiveSetView.Mode = FSActiveSetView.Mode.Practice
    }
    ...
    func SelectEntry(i_Entry: Int, s_Title: String, e_Mode: FSActiveSetView.Mode) -> Void {
